...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'vQixlze9uXJB3RtH1CYqp5WA06DNo2nw',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    //全网数据统计接口
    'allDataStatisticsUrl' => 'https://chain.coinscos.com/api/power/info',
    //分红池余额
    'bonusBalanceUrl' => 'https://chain.coinscos.com/api/admin/usd/balance',
    //分红接口
    'bonusUrl' => 'https://chain.coinscos.com/api/admin/usd/assign',

    //ART合约地址
    'art_contract' => '0x6f9b4f625b36462dfc75840ba496b351b59ca8fd',
    //SOUL合约地址
    'soul_contract' => '0xa2bcf5a89572c7e080d3eb04957d10ed1408fece',
];
